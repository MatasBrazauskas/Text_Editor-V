...
TEST_P(NormalModeCommandParsingTest, HandleLotsOfCases) {
    ...
    for (char i : input) {
        ...
        normalMode.HandleKeyboardInput(editor.editorState_, doc);
    }
...
INSTANTIATE_TEST_SUITE_P(
    ...
    NormalModeCommandParsingTest,
    ::testing::Values(
        ParseParameters{"3", NormalModeCommand{3, ' ', 0, ' ', ' ', ' ', false, ParsingStages::Count1OperationMotionTextObject}},
        ParseParameters{"d", NormalModeCommand{0, 'd', 0, ' ', ' ', ' ', false, ParsingStages::Count2MotionTextObject}},
        ParseParameters{"32d", NormalModeCommand{32, 'd', 0, ' ', ' ', ' ', false, ParsingStages::Count2MotionTextObject}},
        ParseParameters{"32d2", NormalModeCommand{32, 'd', 2, ' ', ' ', ' ', false, ParsingStages::Count2MotionTextObject}},
